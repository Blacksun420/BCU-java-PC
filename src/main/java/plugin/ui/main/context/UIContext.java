...
public abstract class UIContext {
    ...
    public abstract static class UIChecker {
        ...
        private static final String JAR_CHECK_URL = "https://raw.githubusercontent.com/U-YumeTsuki/o-bcu-assets/main/jar/check.json";
        ...
        public static class UpdateJson {
            ...
            public String getURL() {
                return "https://raw.githubusercontent.com/U-YumeTsuki/sun-bcu-assets/main/jar/" + getArtifact();
            }
